...
export default function SignInButton({}: Props) {
  ...
  if (!address) {
    return (
      <div className="container flex flex-col items-center justify-center w-full max-w-lg h-screen mx-auto mb-20">
        <h1 className="text-3xl font-bold text-black">
          Find hackathon partners with Lens
        </h1>
    ...
    return (
      <div className="container flex flex-col items-center justify-center w-full max-w-lg h-screen mx-auto mb-20">
        ...
        {/* <p className="text-black text-base">
          {profileQuery?.data?.defaultProfile?.bio}
        </p> */}
      </div>
    );
  }
