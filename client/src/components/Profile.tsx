    ...
    <div className="flex flex-col items-center">
      <div className="w-1/2 mt-10">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          />
            <div>
              <h2 className="text-xl font-bold">{profileQuery?.data?.defaultProfile?.name}</h2>
              <p className="text-gray-600">{profileQuery?.data?.defaultProfile?.handle}</p>
            </div>
          </div>
          <div className="flex flex-col space-y-6">
            <div>
              <h3 className="text-lg font-bold mb-2">My Proven Skills</h3>
            ...
            <div>
              ...
              {(profileQuery?.data?.defaultProfile?.bio) || "No bio yet"}
              </p>
            </div>
